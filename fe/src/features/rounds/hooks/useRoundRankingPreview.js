// src/features/rounds/ranking/hooks/useRoundRankingPreview.js
import { useCallback, useEffect, useMemo, useState } from "react";
import { roundRankingService } from "../services/roundRankingService";
import { getRankingSummary, groupRankingItems } from "../services/rankingPreviewMapper";
...
export const useRoundRankingPreview = (roundId, options = {}) => {
  ...
  useScoringProgressSocket(roundId, () => {
